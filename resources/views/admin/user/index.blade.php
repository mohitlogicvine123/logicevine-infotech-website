...
<div class="overflow-x-auto mt-5">
    ...
    <table class="table-auto border-collapse w-full whitespace-nowrap text-left text-gray-500 dark:text-dark-text font-medium">
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-dark-border-three">
            ...
            <tr>
                <td class="p-6 py-4 dk-border-one">{{ $user->name }}</td>
                <td class="p-6 py-4 dk-border-one">{{ $user->email }}</td>
                <td class="p-6 py-4 dk-border-one"><img src="{{asset('storage/'.$user->image)}}" alt="ind Image" style="width:100px;"></td>
                <td class="p-6 py-4 dk-border-one">
                    <div class="flex items-center gap-2">
                     <a href="{{ route('user.edit', $user->id) }}" class="btn-icon btn-primary-icon-light size-7 btn b-outline btn-success-outline">
